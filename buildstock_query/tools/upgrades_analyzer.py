...
class UpgradesAnalyzer:
    ...
    def get_minimal_representative_buildings(self, building_groups, include_never_upgraded=False, verbose=False) -> list:
        ...
        vprint(f"Total buildings: {len(all_bldgs)}, Upgraded buildings: {len(upgraded_bldgs)},\
        ...
        while remaining:
            ...
            if verbose:
                ...
                vprint(f"{covered_sets} sets covered by this building will be removed and ~{bldg_count} count of buildings will be decreased.")
...
def main():
    ...
    minimal_bldgs = ua.get_minimal_representative_buildings(report_df['applicable_buildings'].to_list(),
                                                            include_never_upgraded=True, verbose=True)
