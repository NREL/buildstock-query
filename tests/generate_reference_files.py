...
def generate_table_and_cache(table_name: str):
    try:
        ...
        mya1.savings.savings_shape(1, enduses=enduses)  # annual_savings_full
        mya1.savings.savings_shape(1, enduses=enduses, applied_only=True)  # annual_savings_applied =
        ...
        mya1.savings.savings_shape(1, enduses=ts_enduses, annual_only=False)  # ts_savings_full
        mya1.savings.savings_shape(1, enduses=ts_enduses, applied_only=True, annual_only=False)  # ts_savings_applied

        enduses = ['fuel_use_electricity_total_m_btu']
        group_by = ["geometry_building_type_recs"]
        mya1.savings.savings_shape(1, enduses=enduses, group_by=group_by, sort=True)
        mya1.savings.savings_shape(1, enduses=enduses, group_by=group_by, applied_only=True,
                                   sort=True)
        ...
        ts_enduses = ["fuel_use__electricity__total__kwh"]
        mya1.savings.savings_shape(1, enduses=ts_enduses, annual_only=False, group_by=group_by)
        mya1.savings.savings_shape(1, enduses=ts_enduses, applied_only=True, annual_only=False, group_by=group_by)
        group_by = ["geometry_building_type_recs"]
        ts_enduses = ["fuel_use__electricity__total__kwh"]
        mya1.savings.savings_shape(1, enduses=ts_enduses, annual_only=False, sort=True, group_by=group_by)
        mya1.savings.savings_shape(1, enduses=ts_enduses, applied_only=True,
